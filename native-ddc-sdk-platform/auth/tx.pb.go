...
type MsgAddAccount struct {
	...
	Role      native_ddc_sdk_platform.Role `protobuf:"varint,4,opt,name=role,proto3,enum=bianjieai.ddc.Role" json:"role,omitempty"`
...
type MsgAddBatchAccount struct {
	...
	Role      []native_ddc_sdk_platform.Role `protobuf:"varint,4,rep,packed,name=role,proto3,enum=bianjieai.ddc.Role" json:"role,omitempty"`
	LeaderDID string                         `protobuf:"bytes,5,opt,name=leader_did,json=leaderDid,proto3" json:"leader_did,omitempty"`
	Sender    string                         `protobuf:"bytes,6,opt,name=sender,proto3" json:"sender,omitempty"`
}
...
var fileDescriptor_1d23625c3b853733 = []byte{
	...
	,
}
...
func (m *MsgAddBatchAccount) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType == 0 {
				var v native_ddc_sdk_platform.Role
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
						return ErrIntOverflowTx
					}
					...
					b := dAtA[iNdEx]
					iNdEx++
					v |= native_ddc_sdk_platform.Role(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
				...
				if elementCount != 0 && len(m.Role) == 0 {
					m.Role = make([]native_ddc_sdk_platform.Role, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v native_ddc_sdk_platform.Role
					for shift := uint(0); ; shift += 7 {
