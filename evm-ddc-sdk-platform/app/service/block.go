...
func (b *BlockService) GetLatestBlock() (*gethtypes.Block, error) {
	return b.ethClient.BlockByNumber(context.Background(), big.NewInt(int64(gethrpc.LatestBlockNumber)))
}
